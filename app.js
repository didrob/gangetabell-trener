        ...
        <div className="text-center p-4 md:p-8 max-w-6xl mx-auto">
            ...
            {dailyChallenge && !dailyChallenge.completed && (
                <div className="bg-yellow-500/20 backdrop-blur-sm rounded-2xl p-4 mb-6 text-white">
                    <h3 className="text-xl font-bold mb-2">🎯 Daglig utfordring</h3>
                    ...
                    <div className="mt-2">
                        ...
                        <p className="text-sm mt-1">{dailyChallenge.progress}/{dailyChallenge.target}</p>
                    </div>
                </div>
            )}
            ...
            {showAvatarSelect && (
                <div className="mt-6 bg-white/20 backdrop-blur-sm rounded-2xl p-4">
                    <h3 className="text-xl font-bold text-white mb-3">👤 Velg Avatar</h3>
            ...
            {showThemeSelect && (
                <div className="mt-6 bg-white/20 backdrop-blur-sm rounded-2xl p-4">
                    <h3 className="text-xl font-bold text-white mb-3">🎨 Velg Tema</h3>
                    <div className="grid grid-cols-2 gap-3">
                        {THEMES.map(theme => (
                            <button
                                key={theme.id}
            ...
            {showStickers && (
                <div className="mt-6 bg-white/20 backdrop-blur-sm rounded-2xl p-4">
                    <h3 className="text-xl font-bold text-white mb-3">🏷️ Dine Klistremerker</h3>
            ...
            {showTrophies && (
                <div className="mt-6 bg-white/20 backdrop-blur-sm rounded-2xl p-4">
                    <h3 className="text-xl font-bold text-white mb-3">🏆 Troféer</h3>
